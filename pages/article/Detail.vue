...
const [showSide, showSideToggle] = useToggle()
</script>

<template>
  <div py-4 class="relative h-100vh overflow-auto text-center">
    <div hover="op100" sticky top-0 mr-5 inline-block overflow-hidden p-2 px-2 align-top op-30 transition-all hover:bg-light-500 dark:hover:bg-dark:400 class="hide-left">
      <div solar:round-alt-arrow-left-line-duotone text-lg @click="$router.back()" />
    </div>
