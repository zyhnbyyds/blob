...
<template>
  <div :class="props.status === 'error' ? 'text-red' : 'text-[rgb(112,117,121)] hover:text-blue-400  focus-within:text-blue-600'" class="relative text-16px">
    <input :id="props.id" v-model="ipt" :class="outlineColors[props.status]" :autocomplete="autocomplete" :type="type" class="h-52px w-full border rounded-12px px-14px py-11px text-#333 caret-blue-400" focus="bg-dark-200" @focus="handleFocus" @blur="handleBlur">
